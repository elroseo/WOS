...
2. Publish it to the repo with `gh api`:
   ```bash
   # from the vault root
   FILE="30 Resources/Environment/GitHub Profile/profile-readme.md"   # or working-with-me.md
...
**Verify they match:**
```bash
diff <(gh api repos/elroseo/elroseo/contents/README.md --cache 0 --jq '.content' | base64 -d) "30 Resources/Environment/GitHub Profile/profile-readme.md"
```
...
- [[30 Resources/Voice/Writing Style|Writing Style]] (voice for profile copy)
