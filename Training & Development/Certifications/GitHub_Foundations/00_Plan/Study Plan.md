# GitHub Foundations Certification - Study Plan

```
╔═══════════════════════════════════════════╗
║  GitHub Foundations Cert Prep             ║
║  June 22 - July 12, 2026 (6 hrs total)  ║
╚═══════════════════════════════════════════╝
```
...
| Weekly budget | 2 hours |
| Total hours | ~6 |
| Style | Hands-on + concise notes |
| Goal | Pass GitHub Foundations exam |

## Weekly Cadence

- **4 x 30 min sessions** across the week (shorter, more frequent)
- **Weekend review:** 10-min checklist each Sunday to consolidate

## Priority Order

1. Core git/GitHub flow
2. Collaboration features
3. Actions fundamentals
4. Permissions and security basics
5. Exam strategy and trap review

## Weekly Breakdown

### Week 1: Core GitHub Workflow Fundamentals (June 22-28) - 2 hrs
...
- [[../../GitHub/learning/cheatsheets/Git and GitHub|Git and GitHub Cheatsheet]] (already in your vault)
- Practice exams: [ghcertified.com](https://ghcertified.com/practice_tests/foundations/)

## Tracking

> Use the tasks above to track progress. Each session has a due date to keep pace.
> Flashcard reviews are bonus - do them if you have spare time on those days.

## Notes

- You already have hands-on Git experience from the past week (branching, PRs, merging)
- Your CRE role gives you daily exposure to GitHub, so you are reinforcing constantly
- Focus study time on **exam-specific terminology and edge cases** rather than re-learning basics you already use
